...
class CompetitiveCyclistTestCase(unittest.TestCase):
    ...
    def test_get_bike_urls(self):
        ...
        self.assertEqual(len(self._cc._BIKE_ENDPOINTS), len(response))
    ...
    # FIXME: Parsing works but doesn't match dict constants
    ...
    # FIXME: File directory issue (FileNotFoundError)
