...
class ConteBikesTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self._categories = ['road_bikes', 'mountain_bikes', 'commuter_urban', 'comfort',
                            'fitness_bikes', 'hybrid_bikes', 'cruiser', 'cyclocross',
                            'other']
        self._page_size = 30
    ...
    def test_get_subtypes(self):
        ...
        mtb_subtypes = [
            'front_suspension_mountain_bikes', 'full_suspension_mountain_bikes',
            '29_inch_wheel_29ers', '650b_wheel_mountain_bikes', 'fat_bikes',
            'downhill_freeride', 'rigid', 'dirt_jump', 'mountain_frames',
            '29_inch_plus_wheel', '27_5_inch_plus_wheel', '26_inch_wheel'
        ]
        fitness_subtypes = ['fitness_bikes']
        ...
        for key in result['fitness_bikes']:
